...
export function computeCyclePoints(
  current: EventCounts,
  previous: SevoScoreBreakdown | null,
  recentSelections: SelectionNode[],
): { cyclePoints: number; agentsImproved: number; improvementBonus: number } {
